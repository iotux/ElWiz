...
const hassAnnounce = async function () {
  ...
  //
  //         hassDevice(name, uniqueId, devClass, stateClass, uom, stateTopic)
  announce = hassDevice('Start time', 'startTime', 'datetime', 'total_increasing', 'ts', 'startTime');
  client.publish(haTopic + "startTime/config", JSON.stringify(announce, !debug, 2), pubOpts);
  announce = hassDevice('End time', 'endTime', 'datetime', 'total_increasing', 'ts', 'endTime');
  client.publish(haTopic + "endTime/config", JSON.stringify(announce, !debug, 2), pubOpts);

  // Price/cost messages Day2
  announce = hassDeviceDay2('Customer price tomorrow', 'customerPriceDay2', 'monetary', 'total', 'kr/kWh', 'customerPriceDay2');
  client.publish(haTopic + "customerPriceDay2/config", JSON.stringify(announce, !debug, 2), pubOpts);

  announce = hassDeviceDay2('Spot price tomorrow', 'spotPriceDay2', 'monetary', 'total', 'kr/kWh', 'spotPriceDay2');
  client.publish(haTopic + "spotPriceDay2/config", JSON.stringify(announce, !debug, 2), pubOpts);

  announce = hassDeviceDay2('Min price tomorrow', 'minPriceDay2', 'monetary', 'total', 'kr/kWh', 'minPriceDay2');
  client.publish(haTopic + "minPriceDay2/config", JSON.stringify(announce, !debug, 2), pubOpts);

  announce = hassDeviceDay2('Max price tomorrow', 'maxPriceDay2', 'monetary', 'total', 'kr/kWh', 'maxPriceDay2');
  client.publish(haTopic + "maxPriceDay2/config", JSON.stringify(announce, !debug, 2), pubOpts);

  announce = hassDeviceDay2('Average price tomorrow', 'avgPriceDay2', 'monetary', 'total', 'kr/kWh', 'avgPriceDay2');
  client.publish(haTopic + "avgPriceDay2/config", JSON.stringify(announce, !debug, 2), pubOpts);

  announce = hassDeviceDay2('Peak price tomorrow', 'peakPriceDay2', 'monetary', 'total', 'kr/kWh', 'peakPriceDay2');
  client.publish(haTopic + "peakPriceDay2/config", JSON.stringify(announce, !debug, 2), pubOpts);

  announce = hassDeviceDay2('Off-peak price 1 tomorrow', 'offPeakPrice1Day2', 'monetary', 'total', 'kr/kWh', 'offPeakPrice1Day2');
  client.publish(haTopic + "offPeakPrice1Day2/config", JSON.stringify(announce, !debug, 2), pubOpts);

  announce = hassDeviceDay2('Off-peak price 2 tomorrow', 'offPeakPrice2Day2', 'monetary', 'total', 'kr/kWh', 'offPeakPrice2Day2');
  client.publish(haTopic + "offPeakPrice2Day2/config", JSON.stringify(announce, !debug, 2), pubOpts);

  announce = hassDeviceDay2('Start time tomorrow', 'startTimeDay2', 'datetime', 'total_increasing', 'ts', 'startTimeDay2');
  client.publish(haTopic + "startTimeDay2/config", JSON.stringify(announce, !debug, 2), pubOpts);
  announce = hassDeviceDay2('End time tomorrow', 'endTimeDay2', 'datetime', 'total_increasing', 'ts', 'endTimeDay2');
